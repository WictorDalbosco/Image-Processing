...
# Enhancement and Superresolution Section -------------------------------------
...
def joint_cumul_hist(low_res_imgs):
    ...
    #Somar as 4 imagens em 1 e dividir por 4
    ...
    #Aplicar uma single img cumulative histogram
...
#  py grade-single.py -d W:/USP/Matérias/"7º Semestre"/PdI/T1/test_cases -c trabalho1.py -e